...
/**
 * NeonRed Design System — TailwindCSS theme.
 * Drop-in replacement for the app's tailwind.config.js.
 * Copy this whole `theme.extend` block into any Tailwind v3 project to get
 * the exact NeonRed look, animation names and keyframes for ANY new app.
 */
module.exports = {
  content: [
    "./src/**/*.{js,jsx,ts,tsx}",
  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        primary: '#ef4444',   // Red-500  (Neon Red)
        'primary-hover': '#f87171',
        secondary: '#be123c', // Rose-700
        accent: '#ff0000',    // pure neon red
        'text-main': '#ffffff',
        'text-muted': '#9ca3af',
        'text-dim': '#6b7280',
